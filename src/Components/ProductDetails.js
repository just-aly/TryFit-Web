...
export default function ProductDetails() {
  ...
  const [downloadLink, setDownloadLink] = useState("https://expo.dev/artifacts/eas/ttCsDsfrtThQZW84AFJyuf.apk");
        ...
        <div className="modal-overlay" onClick={() => setDownloadModal(false)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()} style={{ textAlign: "center" }}>
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: "10px", marginTop: "15px" }}>
              ...
              <button 
                className="cart-btn" 
                style={{ flex: 1, border: "1px solid #9747FF", background: "transparent" }}
